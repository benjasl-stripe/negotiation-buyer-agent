...
export const BUYER_EVIDENCE_CITATION_RULES = `**Property facts — no fabrication:** Ground truth for any property claim exists only in tool outputs you actually fetched this session.
